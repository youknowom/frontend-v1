...
import testerImg from "../../assets/ProductsImage/3.png";
          ...
          <Container>
            <Row className="align-items-center">
              ...
              <Col xs={12} md={6} className="single-product-info-col mt-4">
                ...
                <h5 className="single-product-model">DIT 5K68 / DIT 5K68_b</h5>
                <p style={{ color: "orange" }}>
                  <b>Order Code - DIT5K68</b>
                </p>

                <h4 className="single-product-description">
                  TEAMS DIT 5K68 – 5kV Insulation Resistance Tester is designed
                  for testing insulation resistance in electrical equipment and
                  cables.
                </h4>
                ...
                <Row className="key-features" data-aos="zoom-in">
                  ...
                  <Col xs={12} className="feature-col">
                    <Row className="feature-row">
                      ...
                      <Col xs={10} md={11}>
                        <p>
                          <strong>Wide Resistance Range</strong>
                        </p>
                      </Col>
                    </Row>
                  </Col>
                  ...
                  <Col xs={12} className="feature-col">
                    <Row className="feature-row">
                      ...
                      <Col xs={10} md={11}>
                        <p>
                          <strong>Compact & Portable Design</strong>
                        </p>
                      </Col>
                    </Row>
                  </Col>
