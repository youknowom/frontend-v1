...
import testerImg from "../../assets/ProductsImage/5.5.png"; // your image path
          ...
          <Container>
            <Row className="align-items-center">
              ...
              <Col xs={12} md={6} className="single-product-info-col mt-4">
                {/* DEVICE NAME */}
                <h1 className="single-product-title">5kV Insulation Tester</h1>

                {/* MODEL NUMBER */}
                <h5 className="single-product-model">DIT 5K5_b</h5>
                <p style={{ color: "orange" }}>
                  {" "}
                  <b>Order Code -//add a data tester wise </b>{" "}
                </p>
